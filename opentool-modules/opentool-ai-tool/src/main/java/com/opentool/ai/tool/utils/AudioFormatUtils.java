package com.opentool.ai.tool.utils;
    ...
    public static final String RIFF_8KHZ_8BIT_MONO_MULAW = "riff-8khz-8bit-mono-mulaw"; // wav文件格式
    public static final String RIFF_16KHZ_16BIT_MONO_PCM = "riff-16khz-16bit-mono-pcm";
    public static final String RIFF_24KHZ_16BIT_MONO_PCM = "riff-24khz-16bit-mono-pcm";
